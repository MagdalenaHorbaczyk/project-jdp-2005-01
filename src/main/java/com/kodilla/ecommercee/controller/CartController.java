...
public class CartController {
    ...
    public List<ProductDto> getCartProducts() {
        ...
        Cart.add(new ProductDto(001L, "Masełko", "Masełko", 4.20, 100L));
        Cart.add(new ProductDto(002L, "Mleko", "Mleko", 2.30, 200L));
        Cart.add(new ProductDto(003L, "Ser", "Ser", 12.50, 300L));
        return Cart;
    }
    ...
    public CartDto addProduct(@RequestBody CartDto cartDto) {
        ...
        CartPUT.add(new ProductDto(001L, "Masełko", "Masełko", 4.20, 100L));
        CartPUT.add(new ProductDto(002L, "Mleko", "Mleko", 2.30, 200L));
        CartPUT.add(new ProductDto(003L, "Ser", "Ser", 12.50, 300L));
